<?php
  if(isset($_POST["btnUpdate"])){
    ...
    $db->query("update mr_supplier set name='$name',phone='$phone',email='$email',address='$address' where id='$id'");
    $success="<b style='background-color:lightgreen;'>Successfuly Updated!</b>";
  }

  if (isset($_POST["btnEdit"])) {
    $id = $_POST["txtId"];
    $supplier_table=$db->query("select id,name,phone,email,address from mr_supplier where id='$id'");
    list($id,$name,$phone,$email,$address)=$supplier_table->fetch_row();
  }
?>
<body>
  <div class="app-title">
